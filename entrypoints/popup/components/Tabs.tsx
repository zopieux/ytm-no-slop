...
import { TAB_KEYWORDS, TAB_SONGS, TAB_ARTISTS, TAB_AI_DB, TAB_HISTORY } from '@/utils/constants';
...
export const Tabs: Component<TabsProps> = (props) => {
  return (
    <div class="tabs">
      ...
      <button
        class={`tab-btn ${props.currentTab === TAB_HISTORY ? 'active' : ''}`}
        onClick={() => props.onTabChange(TAB_HISTORY)}
      >
        History
      </button>
    </div>
