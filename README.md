...
The database of AI slop artists is a crowd-sourced effort by the community, called [*Soul Over AI*](https://souloverai.com), licensed under the [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). This extension uses this database, in addition to manually added entries.
